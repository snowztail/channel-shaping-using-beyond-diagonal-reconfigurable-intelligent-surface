...
\begin{section}{Introduction}
	...
	% Despite the fruitful results, the existing literature on \gls{ris} is still limited to the diagonal phase shift model, where the phase shifters are constrained to be diagonal matrices.
