...
\begin{section}{\gls{bd}-\gls{ris} Model}
	...
	Note that diagonal (single-connected) and unitary (fully-connected) \gls{ris} can be regarded as its extreme cases with group size 1 and $N_\mathrm{S}$, respectively.
	The potential physical architectures of \gls{bd}-\gls{ris} are shown in \cite[Fig. 3]{Shen2020a}, \cite[Fig. 5]{Li2023c}, and \cite[Fig. 2]{Nerini2023a}, where the antenna radiation patterns and circuit network structures are taken into account.
	% Note that \gls{bd}-\gls{ris} reduces to diagonal \gls{ris} and unitary \gls{ris} with group size equal to 1 and $N_\mathrm{S}$, respectively.
	% Note that \gls{bd}-\gls{ris} reduces to diagonal \gls{ris} and unitary \gls{ris} with group size equal to 1 and $N_\mathrm{S}$, respectively.
