...
\begin{section}{Introduction}
	...
	Fourth, we tackle \gls{bd}-\gls{ris}-aided \gls{mimo} \gls{pc} achievable rate maximization problem with two beamforming solutions: a local-optimal approach via \gls{ao} and a low-complexity approach over channel shaping.
