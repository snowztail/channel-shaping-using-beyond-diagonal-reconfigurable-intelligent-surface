...
\begin{section}{Introduction}
	...
	% collective singular value bounds	for rank-deficient channels and unitary \gls{ris}, respectively.
	% 	Results validate those bounds and show
	% for rank-deficient channels and unitary \gls{ris}, respectively.
