...
\begin{section}{Simulation Results}\label{sc:simulation}
	...
	\begin{subsection}{Channel Singular Values Redistribution}
		\begin{subsubsection}{Pareto Frontier}
			...
			When the direct link is absent, the achievable regions in Fig. \subref*{fg:singular_pareto_sx32_nd} are shaped like pizza slices since $\sigma_1(\mathbf{H}) \ge \sigma_2(\mathbf{H}) \ge 0$.
			...
			In Fig. \subref*{fg:singular_pareto_sx32}, a 32-element \gls{ris} cannot compensate the \qty{35}{dB} direct-indirect power imbalance and results in a limited range of singular values.
			...
			It is also worth noticing in Fig. \subref*{fg:singular_pareto_sx128} that the equivalent channel can be completely nulled by a 128-element \gls{bd}-\gls{ris} but not by a diagonal one.
		...
		\begin{subsubsection}{Analytical and Numerical Results}
			...
			Finally, Fig. \subref*{fg:singular_bound_rank4_sx256} confirms there are no extra bounds when both forward and backward channels are full-rank.
