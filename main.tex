...
\begin{section}{Introduction}
	...
	Its benefit has been recently shown in receive power maximization \cite{Nerini2023,Santamaria2023,Fang2023,Nerini2023a}, transmit power minimization \cite{Zhou2023}, and rate maximization \cite{Zhou2023,Nerini2023a,Li2023d,Li2023c,Bartoli2023}.
	...
	Metrics of channel shaping can be classified into \emph{singular value centric} and \emph{power centric}.
	...
	When it comes to \gls{bd} \gls{ris}, the only metric analyzed is the channel power \cite{Nerini2023,Santamaria2023} where the \gls{mimo} case is still unexplored.\footnote{Single-stream \gls{mimo} with given precoder and combiner was considered in \cite{Nerini2023}. It is equivalent \gls{siso} channel shaping.}
	Although insightful, the answers are far from complete and the optimization techniques are limited to very specific scenarios.
	In this paper, we aim to quantify the channel shaping capability of \gls{bd} \gls{ris} through theoretical analysis and numerical evaluation.
	The contributions are summarized below.



	% we aim to answer this question by a simple yet insightful approach: \emph{from diagonal to beyond}.
	% The answer depends heavily on the phase shift model of \gls{ris}.

	% \gls{ris} also offers a new degree of freedom for \emph{channel shaping}, i.e., to reshape the wireless channel to a desired form.
\end{section}
