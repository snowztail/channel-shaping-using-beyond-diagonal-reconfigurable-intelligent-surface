...
\begin{section}{Introduction}
	...
	On the other hand, \gls{bd} \gls{ris} can provide a higher channel power but the results are limited to \gls{siso} \cite{Nerini2023} and \gls{miso} \cite{Santamaria2023}.
	While these studies offer promising glimpses into the channel shaping potential of passive \gls{ris}, a comprehensive understanding of its capabilities and limitations is desired, and a universal design framework is still missing.
	% \footnote{In terms of channel shaping, single-stream \gls{mimo} with given precoder and combiner \cite{Nerini2023} is equivalent to \gls{siso}.}.
