...
\begin{section}{\gls{bd}-\gls{ris} Model}
	...
	\end{equation}
	where $\mathbf{\Theta}_g \in \mathbb{U}^{L \times L}$ is a unitary matrix describing the scatter response of group $g$.
	...
	The potential physical architectures of \gls{bd}-\gls{ris} are shown in \cite[Fig. 3]{Shen2020a}, \cite[Fig. 5]{Li2023c}, and \cite[Fig. 2]{Nerini2023a}, where the radiation pattern and circuit topology significantly influence the scattering matrix.
	...
	One can thus rewrite the equivalent channel as
	\begin{equation}
	...
	\end{equation}
	where the \gls{ris} design involves two critical issues: \emph{subspace alignment} and \emph{subchannel rearrangement}.
	\begin{itemize}
		\item 
	\end{itemize}
...
\begin{section}{Simulation Results}\label{sc:simulation}
	...
	\begin{table*}[!t]
		...
		\begin{tabular}{ccccccc}
			...
			Geodesic                        & $\num{4.36e-3}$                       & 11.61                                  & $\num{2.04e-2}$ & $\num{1.16e-2}$ & 25.78      & 3.21     \\
			Non-geodesic                    & $\num{4.17e-3}$                       & 169.50                                 & $\num{1.42e-1}$ & $\num{8.87e-3}$ & 278.08     & 27.81    \\ \bottomrule
		\end{tabular}
	\end{table*}
