...
[channel.rank.direct, channel.rank.forward, channel.rank.backward, reflect.bond] = deal(min(transmit.antenna, receive.antenna), 2, min(reflect.antenna, receive.antenna), [1, reflect.antenna]);
...
save('data/pc_singular_rank.mat');
...
ylabel('Amplitude');
savefig('plots/pc_singular_rank.fig');
matlab2tikz('../assets/simulation/pc_singular_rank.tex', 'width', '10cm', 'height', '7.5cm', 'extraaxisoptions', {'legend columns=4', 'transpose legend', 'legend style={/tikz/column 2/.style={column sep=5pt}}'});
