...
\newcounter{thm}
\newtcbtheorem[use counter=thm]{thm}%
...
%%% Proposition Box
\newcounter{prop}
\newtcbtheorem[use counter=prop]{prop}%
...
%%% Corollary Box
\newcounter{coro}
\newtcbtheorem[use counter=coro,number within=prop]{coro}%
...
%%% Lemma Box
\newcounter{lem}
\newtcbtheorem[use counter=lem]{lem}%
...
%%% Algorithm Box
\newcounter{algo}
\newtcbtheorem[use counter=algo]{algo}%
